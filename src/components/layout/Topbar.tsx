...
import { LayoutDashboard, Plus, LogOut, User, Settings } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function Topbar() {
  ...
  const navItems = [
    { path: '/site-dashboard', label: 'Tableau de bord', icon: LayoutDashboard },
    { path: '/add-new-site', label: 'Nouveau site', icon: Plus },
  ];
